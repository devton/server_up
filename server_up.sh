...
mkdir_fonts="mkdir /opt/fonts; cd /opt/fonts"
wget_ruby="wget ftp://ftp.ruby-lang.org/pub/ruby/1.9/ruby-1.9.2-p180.tar.gz"
enter_ruby_dir="tar -zxvf ruby-1.9.2-p180.tar.gz;cd ruby-1.9.2-p180"
